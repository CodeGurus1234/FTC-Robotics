...
validates :state, :format => { :with => /\A[a-z A-Z]+\z/, :message => "Only letters allowed" }
validates :city, :format => { :with => /\A[a-z A-Z]+\z/, :message => "Only letters allowed" }
validates :county, :format => { :with => /\A[a-z A-Z]+\z/, :message => "Only letters allowed" }
validates :country, :format => { :with => /\A[a-z A-Z]+\z/, :message => "Only letters allowed" }
validates :main_contact, :format => { :with => /\A.*[a-z A-Z]+\z/, :message => "Only letters allowed" }
validates :main_contact_city, :presence => true #:format => { :with => /\A.*[a-z A-Z]+\z/, :message => "Only letters allowed" }
